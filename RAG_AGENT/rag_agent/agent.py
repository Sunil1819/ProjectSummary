...
from .tools.debug_tools import DUMP_AVAILABLE_CORPORA
root_agent = Agent(
    name="rag_agent",
  ...
  ##DUMP_AVAILABLE_CORPORA:
    - This tool is for debugging purposes only. It dumps all available corpora and their resource names.
      Use it to understand what corpora are available in the system.
